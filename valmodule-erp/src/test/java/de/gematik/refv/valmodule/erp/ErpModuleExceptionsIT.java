...
class ErpModuleExceptionsIT {
  private final IntegratedValidationModule validationModule =
      TestConfigurationBasedValidationModuleFactory.createInstance("erp");
  ...
  void testUnsupportedProfileLeadsToException(String resource) {
    Assertions.assertThrows(
        UnsupportedProfileException.class, () -> validationModule.validateString(resource));
  }
  ...
  void testInvalidResourcesLeadToIllegalArgumentException(String resource) {
    Assertions.assertThrows(
        IllegalArgumentException.class, () -> validationModule.validateString(resource));
  }
}
