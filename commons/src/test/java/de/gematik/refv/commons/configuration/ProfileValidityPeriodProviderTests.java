...
class ProfileValidityPeriodProviderTests {
  ...
  void testDependencyListsWithNonEmptyValidFromAndValidTillAreProcessedCorrectly() {
    DependencyList dl1 =
        new DependencyList("2020-01-01", "2020-02-28", new LinkedList<>(), new LinkedList<>());
    DependencyList dl2 =
        new DependencyList("2020-03-01", "2020-04-30", new LinkedList<>(), new LinkedList<>());
    DependencyList dl3 =
        new DependencyList("2020-04-30", "2020-05-31", new LinkedList<>(), new LinkedList<>());
  ...
  void testDependencyListsWithEmptyValidTillAreProcessedCorrectly() {
    ...
    DependencyList dl2 =
        new DependencyList("2020-03-01", "2020-04-30", new LinkedList<>(), new LinkedList<>());
    DependencyList dl3 =
        new DependencyList("2020-04-30", null, new LinkedList<>(), new LinkedList<>());
  ...
  void testDependencyListsWithMissingValueFromThrowException() {
    DependencyList dl1 =
        new DependencyList(null, "2020-01-31", new LinkedList<>(), new LinkedList<>());
    DependencyList dl2 =
        new DependencyList("2020-02-01", "2020-02-28", new LinkedList<>(), new LinkedList<>());

    var dependencyLists = new DependencyListsWrapper(dl1, dl2);
    Assertions.assertThrows(
        IllegalStateException.class, () -> validityPeriodProvider.calculateFrom(dependencyLists));
  }
}
