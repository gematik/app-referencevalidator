...
class ReferencedProfileLocatorTests {
    ...
    void testProfileInCorrectResourceIsExtractedCorrectly(String canonical) {
        ...
        Optional<Profile> profileOptional = locator.locateInXml(resource);
    ...
    void testNotXmlResource() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> locator.locateInXml("not an xml resource"));
    }
}
