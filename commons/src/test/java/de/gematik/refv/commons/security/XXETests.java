...
/**
 * Cf. <a href="https://en.wikipedia.org/wiki/XML_external_entity_attack#cite_note-3">XML external
 * entity attack</a> Cf. <a
...
public class XXETests {
  ...
  private void assertCorrectSecurityException(Throwable e) {
    ...
    Assertions.assertInstanceOf(
        ...
        e.getCause(),
        "No security exception is thrown (wrong cause type)");
  }
}
