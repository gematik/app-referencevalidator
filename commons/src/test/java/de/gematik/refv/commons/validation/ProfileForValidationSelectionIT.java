...
class ProfileForValidationSelectionIT {
  ...
  class ValidationWithoutProfilePassedAsParameter {
    ...
    class ValidationWithReferencedMetaProfile {
      ...
      void testProfileIsReferencedAndSupported() {
        var result =
            validationModule.validateFile(
                "src/test/resources/profile-for-validation-selection/meta-profile-with-one-supported-profile.json",
                options);
      ...
      void testMultipleReferencedProfilesAndAllSupported() {
        var result =
            validationModule.validateFile(
                "src/test/resources/profile-for-validation-selection/meta-profile-with-multuple-supported-profiles.json",
                options);
      ...
      void testUnknownProfile() {
        Assertions.assertThrows(
            ...
            () ->
                validationModule.validateFile(
                    "src/test/resources/profile-for-validation-selection/meta-profile-with-one-unsupported-profile.json",
                    options));
      }
      ...
      void testUnknownAndSupportedProfile() {
        var result =
            validationModule.validateFile(
                "src/test/resources/profile-for-validation-selection/meta-profile-with-multuple-supported-and-unsupported-profiles.json",
                options);
    ...
    class ValidationWithoutReferencedMetaProfile {
      ...
      void testNoProfile() {
        Assertions.assertThrows(
            ...
            () ->
                validationModule.validateFile(
                    "src/test/resources/profile-for-validation-selection/no-meta-profile.json",
                    options));
      }
    }
    ...
    class ValidationWithoutReferencedMetaProfileButWithMetaProfileInInnerRessource {
      ...
      void testNoProfileOnTopLevelButInInnerResource() {
        Assertions.assertThrows(
            ...
            () ->
                validationModule.validateFile(
                    "src/test/resources/profile-for-validation-selection/no-meta-profile-on-top-level-but-in-inner-resource.json",
                    options));
      }
    }
  }
  ...
  class ValidationWithProfilePassedAsParameter {
    ...
    class ValidationWithReferencedMetaProfile {
      ...
      @SneakyThrows
      @DisplayName(
          "passed profile is not referenced and unsupported --> UnsupportedProfileException")
