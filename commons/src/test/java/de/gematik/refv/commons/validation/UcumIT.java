...
class UcumIT {
    ...
    @ParameterizedTest
    @ValueSource(strings = {
            "src/test/resources/ucum/invalid/invalid-ucum-code.xml",
            "src/test/resources/ucum/invalid/ucum-code-with-non-ascii-symbols.xml"
    })
    @SneakyThrows
    void testUcumValidationIsOnAndLeadsToErrorByDefault(String path) {
