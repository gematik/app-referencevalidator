...
public class UcumValidationSupportTests {
  ...
  public static final IValidationSupport.IssueSeverity ISSUE_SEVERITY =
  ...
  void severityLevelCanBeConfigured() {
    ...
    UcumValidationSupport support =
        new UcumValidationSupport(FhirContext.forR4(), newIssueSeverity);
    ...
    var result =
        validationSupportChain.validateCode(
  ...
  private IValidationSupport.CodeValidationResult getResult(String code) {
    return validationSupportChain.validateCode(
        validationSupportContext,
        null,
        CommonCodeSystemsTerminologyService.UCUM_CODESYSTEM_URL,
        code,
