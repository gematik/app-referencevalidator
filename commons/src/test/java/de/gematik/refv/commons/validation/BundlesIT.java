...
class BundlesIT {
  ...
  private static void assertInvalidAndThatMessageIdIsReturned(String path, String messageId)
      throws IOException {
  ...
  private static void assertValidAndThatMessageIdIsReturned(String path, String messageId)
      throws IOException {
