...
class IgnoreValueSetValidationSupportTests {
  ...
  void testMissingValueSetsAreIgnored() {
    ...
    var result =
        support.validateCodeInValueSet(
            new ValidationSupportContext(validationSupportChain),
  ...
  void testUnregisteredValueSetsAreUnsupported() {
    ...
    Assertions.assertFalse(
        support.isValueSetSupported(
            new ValidationSupportContext(validationSupportChain), "http://c"));
  }
  ...
  void testEmptyValueSetsAreUnsupported() {
    ...
    ValidationSupportChain validationSupportChain =
        new ValidationSupportChain(new DefaultProfileValidationSupport(fhirContext));
    Assertions.assertFalse(
        support.isValueSetSupported(new ValidationSupportContext(validationSupportChain), null));
  }
