...
class ReferencedProfileLocatorJSONTests {
  ...
  @ParameterizedTest
  @ValueSource(strings = {"https://bla.bla|1.0.2", "https://bla.bla"})
  ...
  void corruptedJsonResource(String resource) {
    Assertions.assertThrows(
        IllegalArgumentException.class, () -> locator.getAllReferencedProfilesInResource(resource));
  }
  ...
  void testNotJsonResource() {
    Assertions.assertThrows(
        ...
        () -> locator.getAllReferencedProfilesInResource("not a json resource"));
  }
  ...
  void testMultipleProfiles() {
    ...
    List<String> allReferencedProfilesInResource =
        locator.getAllReferencedProfilesInResource(resource);
