...
/**
 * Load resources (NPM package or patch) using a classpath specification, e.g. <code>
 * /path/to/resource/my_package.tgz</code>. The classpath spec can optionally be prefixed with the
 * string <code>classpath:</code>
 *
