...
public class ValidationResult {
  @Getter private final Collection<SingleValidationMessage> validationMessages;
  ...
  public String toString() {
    ...
    if (!getValidationMessages().isEmpty()) {
      ...
      for (var item : getValidationMessages()) {
        result.append(item);
        result.append("\r\n");
      }
    }
  ...
  public static ValidationResult createInstance(
      ResultSeverityEnum severity, String messageId, String diagnostics) {
