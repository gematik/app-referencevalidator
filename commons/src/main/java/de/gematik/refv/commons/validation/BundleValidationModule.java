...
/**
 * The module is a backport of fullUrl and ID match validation introduced by a <a
 * href="https://github.com/hapifhir/org.hl7.fhir.core/commit/4c6a318749d164466d2bf31918a3969f239c4ca8">version
 * of Java Core Validator</a>, which is later than the one used at the moment. However, the original
 * implementation behaves incorrectly for fullUrls being URNs (cf.
 * BundleValidationModuleTests.validateResourceWithValidUrnFullUrlAndId). Once the original
 * implementation is fixed, this module can be completely removed.
 */
class BundleValidationModule implements IValidatorModule {
  ...
  private static final String MESSAGE_TEMPLATE =
      "The fullUrl ''{0}'' looks like a RESTful server URL, so it must end with the correct type and id (/{1}/{2})";
