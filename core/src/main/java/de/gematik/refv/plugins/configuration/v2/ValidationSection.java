...
public class ValidationSection {
  @NonNull private List<DependencyList> dependencyLists;
  ...
  public List<DependencyList> getDependencyLists() {
    return Collections.unmodifiableList(
        Objects.requireNonNullElseGet(dependencyLists, LinkedList::new));
  }

  public List<String> getAcceptedEncodings() {
    return Collections.unmodifiableList(
        Objects.requireNonNullElseGet(acceptedEncodings, LinkedList::new));
  }

  public List<String> getIgnoredCodeSystems() {
    return Collections.unmodifiableList(
        Objects.requireNonNullElseGet(ignoredCodeSystems, LinkedList::new));
  }

  public List<String> getIgnoredValueSets() {
    return Collections.unmodifiableList(
        Objects.requireNonNullElseGet(ignoredValueSets, LinkedList::new));
  }
}
