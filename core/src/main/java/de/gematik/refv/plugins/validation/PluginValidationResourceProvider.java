...
public class PluginValidationResourceProvider extends BaseValidationResourceProvider {
  ...
  @java.lang.SuppressWarnings({
    "squid:S3077"
  }) // Reason for usage of volatile https://stackoverflow.com/a/7855774
  private volatile ValidationModuleConfiguration cachedConfiguration;

  private final Object lockObject = new Object();

  public PluginValidationResourceProvider(
      Function<String, InputStream> resourceLoaderFunction, FhirContext fhirContext) {
  ...
  public ValidationModuleConfiguration getConfiguration() {
    if (cachedConfiguration == null) {
      // Double-checked locking pattern, cf.
        ...
        if (cachedConfiguration == null) {
          ...
          try (InputStream pluginDefinitionFile = getResource(CONFIG_FILE)) {
            ...
            if (specVersion.toString().startsWith("1.")) {
              var pluginDefinitionV1 =
                  mapper.readValue(
                      yamlContent, de.gematik.refv.plugins.configuration.v1.PluginDefinition.class);
              cachedConfiguration =
                  ValidationModuleConfigurationFactory.createFrom(
                      pluginDefinitionV1, fhirContext, resourceLoaderFunction);
            } else if (specVersion.toString().startsWith("2.")) {
              var pluginDefinitionV2 = mapper.readValue(yamlContent, PluginDefinition.class);
              cachedConfiguration =
                  de.gematik.refv.plugins.configuration.v2.ValidationModuleConfigurationFactory
                      .createFrom(pluginDefinitionV2, fhirContext, resourceLoaderFunction);
            } else
