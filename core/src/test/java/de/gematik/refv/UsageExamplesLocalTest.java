...
class UsageExamplesLocalTest {
  ...
  void validateFile() {
    ...
    ValidationResult result =
        erpModule.validateFile("src/test/resources/SimpleMedicationRequest.xml");
  ...
  void setOptions() {
    ...
    ValidationResult result =
        erpModule.validateFile("src/test/resources/SimpleMedicationRequest.xml", options);
    System.out.println(result.isValid());
    System.out.println(result.getValidationMessages());
  }
  ...
  void validateUsingPlugin() {
    Plugin plugin =
        Plugin.createFromZipFile(new ZipFile("src/test/resources/plugins/minimal-plugin.zip"));
    var pluginModule = new ValidationModuleFactory().createValidationModuleFromPlugin(plugin);
    var result =
        pluginModule.validateFile(
