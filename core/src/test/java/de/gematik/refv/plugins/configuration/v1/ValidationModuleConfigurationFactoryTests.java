...
public class ValidationModuleConfigurationFactoryTests {
  ...
  private static de.gematik.refv.plugins.configuration.v1.PluginDefinition
  ...
  void testSupportedProfilesArePopulatedCorrectly() {
    ...
    assertThat(sp1.getProfileVersions().get("1.0.0").getCreationDateLocator()).isNull();
  }
  ...
  void testDependenciesArePopulatedCorrectly() {
    ...
    assertThat(dl1.getValidationMessageTransformations())
        .isEqualTo(testPluginDefinition.getValidation().getValidationMessageTransformations());
  }
}
