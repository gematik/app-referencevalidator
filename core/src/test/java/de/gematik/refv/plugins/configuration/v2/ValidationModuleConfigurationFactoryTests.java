...
public class ValidationModuleConfigurationFactoryTests {
  ...
  private static void assertProfileSectionForVersionlessCanonicalsIsCreatedCorrectly(
      SupportedProfileVersions sp1) {
    ...
    assertThat(sp1.getProfileVersions().get("0.0.0").getDependencyLists())
        .isEqualTo(
            List.of("simplevalidationmodule.test#1.0.1", "simplevalidationmodule.test#2.0.0"));
  }
  ...
  void testDependenciesArePopulatedCorrectly() {
    ...
    assertThat(dl2.getValidationMessageTransformations()).isEmpty();
  }
  ...
  private static PluginDefinition createTestPluginDefinition() {
    ...
    return new PluginDefinition(
        ...
        new ValidationSection(
            ...
            false,
            List.of("xml"),
            List.of("http://cs.example.org"),
            List.of("http://vs.example.org")),
        null);
  }
